...
from inference import get_coralscop, get_inference_metrics, run_coralscop, visualize_predictions

parser = argparse.ArgumentParser()
parser.add_argument("--test_img_path", type=str, default="imgs", help="The test image path")
parser.add_argument("--json_mask_output", type=str, default="json_output", help="Path to save masks in JSON format")
...
print("Average Stability score for all images is: ", sum(sta.values())/len(sta.values()))
